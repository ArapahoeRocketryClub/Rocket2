...
template <typename type>
type sum(type *currentVal, int numTerms)
{
...
template <typename type>
type weightedSum(type *firstElement, int numTerms, type weight)
{
...
template <typename type>
type mean(type *firstElement, int numTerms)
{
...
template <typename type>
type sampVar(type *currentVal, int numTerms)
{
